...
<div class="footer">
    <div class="inner">
        <h1><a href=""><img src="<c:url value='/'/>images/logo_footer.png" alt="표준프레임워크 포털 eGovFrame"></a></h1>
        ...
        <div class="right_col">
            ...
            <a href=""><img src="<c:url value='/'/>images/banner02.png" alt="NIA 한국지능정보사회진흥원"></a>
        </div>
    </div>
</div>